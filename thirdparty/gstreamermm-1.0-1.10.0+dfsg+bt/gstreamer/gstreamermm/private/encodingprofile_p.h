...
#ifndef _GSTREAMERMM_ENCODINGPROFILE_P_H
#define _GSTREAMERMM_ENCODINGPROFILE_P_H
...
class EncodingProfile_Class : public Glib::Class
{
public:
...
#endif /* _GSTREAMERMM_ENCODINGPROFILE_P_H */
