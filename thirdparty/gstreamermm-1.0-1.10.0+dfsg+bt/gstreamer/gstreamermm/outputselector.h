...
using GstOutputSelector = struct _GstOutputSelector;
using GstOutputSelectorClass = struct _GstOutputSelectorClass;
...
public:
  using CppObjectType = OutputSelector;
  using CppClassType = OutputSelector_Class;
  using BaseObjectType = GstOutputSelector;
  using BaseClassType = GstOutputSelectorClass;

  // noncopyable
  OutputSelector(const OutputSelector&) = delete;
  OutputSelector& operator=(const OutputSelector&) = delete;
...
public:
  ...
  OutputSelector(OutputSelector&& src) noexcept;
  OutputSelector& operator=(OutputSelector&& src) noexcept;

  ~OutputSelector() noexcept override;
