...
public:
  ...
  /** Inserts the tags of the @a other list into the first list using the given mode.
   * 
   * @param other List to merge from.
   * @param mode The mode to use.
   */
  void insert(const Gst::TagList& other, TagMergeMode mode =  TAG_MERGE_PREPEND);

 
  /** Merges the two given lists into a new list. If one of the lists is <tt>nullptr</tt>, a
   * copy of the other is returned. If both lists are <tt>nullptr</tt>, <tt>nullptr</tt> is returned.
   * 
   * Free-function: gst_tag_list_unref
   * 
   * @param other Second list to merge.
   * @param mode The mode to use.
   * @return The new list.
   */
