...
/** 
 *  @var IteratorItem ITERATOR_ITEM_SKIP
 * Skip this item.
 * 
 *  @var IteratorItem ITERATOR_ITEM_PASS
 * Return item.
 * 
 *  @var IteratorItem ITERATOR_ITEM_END
...
/** 
 *  @var IteratorResult ITERATOR_DONE
 * No more items in the iterator.
 * 
 *  @var IteratorResult ITERATOR_OK
 * An item was retrieved.
 * 
 *  @var IteratorResult ITERATOR_RESYNC
 * Datastructure changed while iterating.
 * 
 *  @var IteratorResult ITERATOR_ERROR
 * An error happened.
 * 
 *  @enum IteratorResult
 * 
