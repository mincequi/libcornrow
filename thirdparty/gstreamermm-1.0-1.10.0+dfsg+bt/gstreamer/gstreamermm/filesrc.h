...
using GstFileSrc = struct _GstFileSrc;
using GstFileSrcClass = struct _GstFileSrcClass;
...
public:
  using CppObjectType = FileSrc;
  using CppClassType = FileSrc_Class;
  using BaseObjectType = GstFileSrc;
  using BaseClassType = GstFileSrcClass;

  // noncopyable
  FileSrc(const FileSrc&) = delete;
  FileSrc& operator=(const FileSrc&) = delete;
...
public:
  ...
  FileSrc(FileSrc&& src) noexcept;
  FileSrc& operator=(FileSrc&& src) noexcept;

  ~FileSrc() noexcept override;
